...
public enum HttpStatusCode {
     ...
     * {@link HttpStatusCode.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusCode.Series#SUCCESSFUL}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusCode.Series#REDIRECTION}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusCode.Series#CLIENT_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusCode.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     * @since 4.0
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusCode.Series#CLIENT_ERROR} or
     * {@link HttpStatusCode.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
