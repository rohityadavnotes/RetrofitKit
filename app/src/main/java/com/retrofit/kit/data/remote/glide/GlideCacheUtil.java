package com.retrofit.kit.data.remote.glide;
...
import com.retrofit.kit.utilities.file.MemoryUtils;
import java.io.File;
...
public class GlideCacheUtil {
    ...
    public String getCacheSize(Context context){
        try {
            return MemoryUtils.getReadableFileSize(getFolderSize(new File(context.getApplicationContext().getCacheDir()+"/"+ InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        }catch (Exception e){
            e.printStackTrace();
        }
        return "";
