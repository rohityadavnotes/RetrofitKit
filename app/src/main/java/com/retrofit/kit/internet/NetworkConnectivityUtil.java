        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        {
            if (connectivityManager != null)
            {
                ...
                if(networkCapabilities != null)
                {
                    ...
                    {
                        LogcatUtils.errorMessage("Network", "getNetworkCapabilities(connectivityManager.getActiveNetwork()) : MOBILE");
                        connectedBoolean    = true;
                        connectedInt        = 1;
                    }
                    else if (networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI))
                    {
                        LogcatUtils.errorMessage("Network", "getNetworkCapabilities(connectivityManager.getActiveNetwork()) : WIFI");
                        connectedBoolean    = true;
                        connectedInt        = 2;
                    }
                }
                ...
                if (networks != null)
                    for (int i = 0; i < networks.length; i++)
                    {
                        ...
                        if(networkCapabilities != null)
                        {
                            if(networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR))
                            {
                                LogcatUtils.errorMessage("Network", "getAllNetworks() : MOBILE");
                                connectedBoolean    = true;
                                connectedInt        = 1;
                                break;
                            }
                            ...
                            {
                                LogcatUtils.errorMessage("Network", "getAllNetworks() : WIFI");
                                connectedBoolean    = true;
                                connectedInt        = 2;
                                break;
                            }
                ...
                if (networkInfos != null)
                {
                    for (int i = 0; i < networkInfos.length; i++)
                    {
                        if (networkInfos[i].getState() == NetworkInfo.State.CONNECTED)
                        {
                            ...
                            {
                                LogcatUtils.errorMessage("Network", "getAllNetworkInfo() : MOBILE");
                                connectedBoolean    = true;
                                connectedInt        = 1;
                                break;
                            }
                            ...
                            {
                                LogcatUtils.errorMessage("Network", "getAllNetworkInfo() : WIFI");
                                connectedBoolean    = true;
                                connectedInt        = 2;
                                break;
                            }
