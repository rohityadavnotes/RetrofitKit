...
public class NetworkCallbackImpl extends ConnectivityManager.NetworkCallback {
    ...
    public void onAvailable(@NonNull Network network) {
        ...
        LogcatUtils.informationMessage(TAG,"Network Available (CONNECTED)");
    ...
    public void onLosing(@NonNull Network network, int maxMsToLive) {
         ...
         */
        LogcatUtils.informationMessage(TAG,"Network Losing");
    ...
    public void onLost(@NonNull Network network) {
        ...
        LogcatUtils.informationMessage(TAG,"Network Lost (DISCONNECTED)");
        context.sendBroadcast(getNetworkAvailabilityIntent(false));
    }
    ...
    public void onUnavailable() {
         ...
         */
        LogcatUtils.informationMessage(TAG,"Network Unavailable");
        context.sendBroadcast(getNetworkAvailabilityIntent(false));
    }
    ...
    public void onCapabilitiesChanged(@NonNull Network network, @NonNull NetworkCapabilities networkCapabilities) {
        ...
        LogcatUtils.informationMessage(TAG,"onCapabilitiesChanged : isInternet = " + isInternet);
    ...
    public void onLinkPropertiesChanged(@NonNull Network network, @NonNull LinkProperties linkProperties) {
         ...
         */
        LogcatUtils.informationMessage(TAG,"onLinkPropertiesChanged");
    }
    ...
    public void onBlockedStatusChanged(@NonNull Network network, boolean blocked) {
         ...
         */
        LogcatUtils.informationMessage(TAG,"onBlockedStatusChanged");
    }
